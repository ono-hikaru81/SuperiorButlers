...
namespace spesium {
    namespace tool {
        void Camera::UpdatePos( const Vector3<double>& distance_characters_pos1_, const Vector3<double>& distance_characters_pos2_ ) {
        ...
        void Camera::UpdateFlat( const Vector3<double>& distance_characters_pos1_, const Vector3<double>& distance_characters_pos2_ ) {
        ...
        void Camera::UpdateDepth( const Vector3<double>& distance_characters_pos1_, const Vector3<double>& distance_characters_pos2_ ) {
