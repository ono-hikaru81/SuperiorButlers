        ...
        class Human : public CharacterBase {
           ...
           private:
            ...
            struct InitMotionTime {
                ...
                static constexpr float strongAttack { 318.0f };  // 強攻撃
                static constexpr float aerialNeutralAttack { 340.0f };  // 空中弱攻撃
                static constexpr float aerialStrongAttack { 358.0f };  // 空中強攻撃
                static constexpr float fallLanding { 387.0f };  // 落下着地
                static constexpr float smallHitBack { 421.0f };  // ノックバック小
                static constexpr float bigHitBack { 426.0f };  // ノックバック大
                static constexpr float fall { 469.0f };  //　落下
                static constexpr float turn { 516.0f };  // 振りむき
            };
