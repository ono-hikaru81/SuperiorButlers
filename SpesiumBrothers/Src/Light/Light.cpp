...
namespace tool
{
	...
	void Light::CreatePointLight(Vector3 pos_, float max_range_, float attenuation_0_, float attenuation_1_, float attenuation_2_)
	{
		// d = ライトから頂点への距離
	...
	void Light::CreateSpotLight(Vector3 pos_, Vector3 direction_, float angle_, float angle_attenuation_, float max_range_, float attenuation_0_, float attenuation_1_, float attenuation_2_)
	{
